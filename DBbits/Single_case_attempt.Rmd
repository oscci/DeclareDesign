...
```{r specifygeneralparameters,echo=F}
  ...
  r = .5 #estimated correlation between successive measures without any intervention
```
...
Y2_1 = r*Y1_1+sqrt(1-r^2)*U, #Y1_1 is baseline measure, Y2_1 is 2nd baseline, correlates with Y1_1 with correlation r
  Y1_2 = r*Y2_1+sqrt(1-r^2)*U, #Y1_2 is first post-intervention measure, correlates with Y3_1
  ...
  Y2_1 = if_else(Y2_1 > 10, 10, round(Y2_1,0)),
  Y1_2_Z = if_else(Y1_2_Z>10, 10, round(Y1_2_Z,0)),
  Y2_2_Z = if_else(Y2_2_Z>10, 10, round(Y2_2_Z,0)),
...
M3 <- declare_model(
  ...
  Y2_1 = if_else(Y2_1 > 10, 10, round(Y2_1,0)),
  Y3_1 = if_else(Y3_1 > 10, 10, round(Y3_1,0)),
  Y1_2_Z = if_else(Y1_2_Z>10, 10, round(Y1_2_Z,0)),
  Y2_2_Z = if_else(Y2_2_Z>10, 10, round(Y2_2_Z,0)),
  Y3_2_Z = if_else(Y3_2_Z>10, 10, round(Y3_2_Z,0)),
  Y2_1 = if_else(Y2_1 < 0, 0, Y2_1),
