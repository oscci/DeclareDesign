...
#ARMA is autoregressive moving average model.
#Looks like arima-sim is mostly used in contexts of prediction.
...
ggplot(simcalder,aes(x=timept,y=treated_outcome,colour=sublabel,linetype=as.factor(responder),group=sublabel)) + geom_line()
