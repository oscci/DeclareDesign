...
In Panel D, data are similar to those in panel C, except that we now consider the third person singular morpheme on the Y-axis. Because this morpheme is similar to -ed, in that it involves inflecting a verb stem, it is plausible that some children might show generalisation of learning. Four children, 1, 14, 19 and 22, showed improvement on both the third person singular and past tense -ed. Could this just be indicative of general improvement due to improved motivation or familiarity with the task? We argued that was likely to be the explanation for those who improved on possessives. Some reassurance may be provided in cases where there was improvement on the third person singular but not on the possessive - this was the case for participants 1, 14 and 22. However, participant 19 improved on all three morpheme types, and so their results look more compatible with a general non-specific improvement, rather than a selective effect of intervention.
