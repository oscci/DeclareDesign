...
```{r answerA,echo=T}
A <- declare_estimator(
  correctcat ~ 1, model = lm_robust, inquiry = "meancorrcat") #This is responder/nonresponder categorisation correct
A2 <- declare_estimator(
  correctbusk ~ 1, model = lm_robust, label = "meancorrbusk") #This is categorisation by busk
...
simulations <- simulate_design(designA2, sims = 100)
