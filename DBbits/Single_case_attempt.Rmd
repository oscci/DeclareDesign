...
#This could therefore be modelled by specifying a latent measure for pre and for post, and then having measures selected to be correlated with latent measure
```
...
```{r specifygeneralparameters,echo=F}
  ...
  nitems = 30 #N items per inflection
